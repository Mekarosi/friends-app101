...
class GsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create g" do
    assert_difference('G.count') do
      post gs_url, params: { g: { email: @g.email, first_name: @g.first_name, friends: @g.friends, last_name: @g.last_name, phone: @g.phone, twitter: @g.twitter } }
    end
  ...
  test "should update g" do
    patch g_url(@g), params: { g: { email: @g.email, first_name: @g.first_name, friends: @g.friends, last_name: @g.last_name, phone: @g.phone, twitter: @g.twitter } }
